<section class="ffooter">
		<footer class="page-footer">
          <div class="container">
            <div class="row">
              <div class="col l6 s12">
                ...
                <p class="grey-text text-lighten-4">1/3 Hazi Road,Mirpur-2,Dhaka</p>
                <p class="grey-text text-lighten-4">Phone : 01735357686</p>
              </div>
          ...
          <div class="footer-copyright">
            <div class="container">
            © 2019 Copyright @ Online Medical Service
