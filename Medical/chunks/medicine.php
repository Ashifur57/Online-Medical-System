...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<br />
			<br />
			<h1 align="center"><a>Medicine</a></h1><br />
			<br /><br />
			<?php
				...
				?>
			<div class="col-md-4">
				<form method="post" action="medicine.php?action=add&id=<?php echo $row["id"]; ?>">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="medicine.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
					<?php
	...
	<br />
 	<div class="card-content center">
		<a href="order.php" style="background: #ee6e73;" class="btn waves-effect waves-block waves-light" >Buy Now</a>
	</div>
	</body>
</html>
